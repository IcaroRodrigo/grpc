...
CREATE TABLE `pedido` (
  ...
  `detalhes` text,
  `carta_bilhete` text,
  `nome_presenteado` varchar(45) NOT NULL,
  `telefone_presenteado` varchar(15) NOT NULL,
  `excluido` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_pedido_forma_pagamento_idx` (`id_forma_pagamento`),
  KEY `fk_pedido_status_pedido_idx` (`id_status`),
  CONSTRAINT `fk_pedido_forma_pagamento` FOREIGN KEY (`id_forma_pagamento`) REFERENCES `forma_pagamento` (`id`),
  CONSTRAINT `fk_pedido_status_pedido` FOREIGN KEY (`id_status`) REFERENCES `status_pedido` (`id`)
...
-- Dump completed on 2024-02-04 14:38:51
